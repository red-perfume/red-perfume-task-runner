 ...
 * @param  {string} params.input         String of valid HTML
 * @param  {object} params.classMap      Map generated by css.js containing class names as the key with array of atomized style class name strings as the value
 * @param  {Array}  params.markupErrors  Array of error messages
 * @param  {object} params.minify        The minify options
...
const html = function (options, { input, classMap, markupErrors, minify }) {
  ...
  const minificationOptions = minificationSettings.generateHtmlMinificationOptions(minify);
